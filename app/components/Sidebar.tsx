...
export default function Sidebar({ userName }: SidebarProps) {
      ...
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path
            ...
            strokeLinejoin="round"
            strokeWidth={2}
            d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 01-2-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"
          />
        </svg>
      ),
    },
  ...
  const safeInitial = (userName && userName.trim().charAt(0).toUpperCase()) || 'U';

  return (
    <aside className="w-64 bg-white border-r border-border flex flex-col h-screen fixed left-0 top-0 z-50">
      {/* Logo */}
